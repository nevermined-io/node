...
describe('AuthService', () => {
    ...
    describe('validateOwner', () => {
        it('should validate the owner and return true if the owner has permission to access', async () => {
            ...
            expect(nvmServiceMock.getNevermined().keeper.conditions.accessCondition.checkPermissions).toHaveBeenCalledWith(consumer_address, did)
        })
    })
    ...
    describe('validateAccess', () => {
        it('should validate the access and return true if the service is granted', async () => {
            ...
            expect(await nvmServiceMock.getNevermined().assets.servicePlugin.access.accept).toHaveBeenCalledWith(params)
        })
    })
    ...
    describe('ValidateTransferProof', () => {
        it('should throw an error if the signature is invalid', async () => {
            ...
            const params: ValidationParams = {
                ...
                babysig: '0x0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef' as never as Babysig
            }

            await expect(authService.validateTransferProof(params)).rejects.toThrowError(UnauthorizedException)
